...
int p = 0;int i = 0;int j = 0;int k =0; int q = 0; int t = 33; int u = 0; int x = 0;
...
void blink_led2(){ // when publish data
  for (int o = 0; o <= 2; o++){
          ...
          if((is_calibrate == false) && (instruction_calibrate == 1)){
            ...
            if((p==cal_literation)&&(i>=15)){
              ...
              if(k >= 15){
                ...
                for(int x = 0; x <= 15; x++){
                  _sendData2 += "\",\"m_irms_ch";
                  _sendData2 += x;
                  _sendData2 += "\":\"";
                  _sendData2 += m_irms0[x];
                }
                for(int y = 0; y <= 15; y++){
                  _sendData2 += "\",\"m_irms_ch";
                  _sendData2 += y+16;
                  _sendData2 += "\":\"";
                  _sendData2 += m_irms1[y];
                }
                _sendData2 += "\"}]";
