...
// KalmanFilter Varible
float XtRS, Xt_updateRS, Xt_prevRS;
float XtST, Xt_updateST, Xt_prevST;
float XtTR, Xt_updateTR, Xt_prevTR;
float PtRS, PtST, PtTR, Pt_updateRS, Pt_updateST, Pt_updateTR, Pt_prev;
float KtRS, KtST, KtTR, R, Q;
...
void voltageMeasure() {
  ...
  Xt_updateRS = Xt_prevRS;
  Pt_updateRS = Pt_prev + Q;
  KtRS = Pt_updateRS / (Pt_updateRS + R);
  XtRS = Xt_updateRS + ( KtRS * (real_valueRS - Xt_updateRS));
  PtRS = (1-KtRS) * Pt_updateRS;
  Xt_prevRS = XtRS;
  Pt_prev = PtRS;
  float peakRS = XtRS;
...
//      MvAvgRS = sum0 / AvgSize;
  ...
  Xt_updateST = Xt_prevST;
  Pt_updateST = Pt_prev + Q;
  KtST = Pt_updateST / (Pt_updateST + R);
  XtST = Xt_updateST + ( KtST * (real_valueST - Xt_updateST));
  PtST = (1-KtST) * Pt_updateST;
  Xt_prevST = XtST;
  Pt_prev = PtST;
  float peakST = XtST;
  //MeasureST
...
//      MvAvgST = sum1 / AvgSize;
  ...
  Xt_updateTR = Xt_prevTR;
  Pt_updateTR = Pt_prev + Q;
  KtTR = Pt_updateTR / (Pt_updateTR + R);
  XtTR = Xt_updateTR + ( KtTR * (real_valueTR - Xt_updateTR));
  PtTR = (1-KtTR) * Pt_updateTR;
  Xt_prevTR = XtTR;
  Pt_prev = PtTR;
  float peakTR = XtTR;
  //MeasureTR
