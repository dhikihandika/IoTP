...
void loop() {
  ...
  while(true) {   
    inputStatsR.input(analogRead(A0));                  // log to Stats function Vr
    inputStatsS.input(analogRead(A3));                  // log to Stats function Vs
    inputStatsT.input(analogRead(A6));                  // log to Stats function Vt
    ...
    if((unsigned long)(millis() - previousMillis) >= printPeriod){
      ...
      Serial.print( "VoltageR: " );Serial.print(VoltsR);Serial.print("|");
      Serial.print( "VoltageS: " );Serial.print(VoltsS);Serial.print("|");
      Serial.print( "VoltageT: " );Serial.println(VoltsT);
